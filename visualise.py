...
from dhd.data import prepare_dataloaders
from dhd.trainer import TrainingModule
from dhd.utils.instance import predict_instance_segmentation, generate_gt_instance_segmentation
from dhd.utils.network import NormalizeInverse
from dhd.utils.visualisation import (convert_figure_numpy,
...
def plot_prediction(image, output, cfg):
    ...
    for imgi, img in enumerate(image[0, -1]):
        ...
        plt.annotate(cameras[imgi].replace('_', ' ').replace('UAV', 'Drone'), (0.05, 0.85), c='white',  # #
